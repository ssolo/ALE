...
// Compilation:  g++ -o ALE_compareTreeDistributions
// ALE_compareTreeDistributions.cpp ALE.h ALE.cpp ALE_util.h ALE_util.cpp
// exODT.h exODT.cpp model_omp.cpp -std=c++0x -I/usr/local/include  -L.
// -L/usr/local/lib  -lbpp-core -lbpp-seq -lbpp-phyl
//   g++ -g -o ALE_compareTreeDistributions ALE_compareTreeDistributions.cpp
//   ALE.h ALE.cpp ALE_util.h ALE_util.cpp exODT.h exODT.cpp model_omp.cpp
//   -std=c++0x -I/usr/include  -I/home/ssolo/newest_bpp/include -L.
//   -L/home/ssolo/newest_bpp/lib -L/usr/lib  -lbpp-core -lbpp-seq -lbpp-phyl

int main(int argc, char **argv) {
  if (argc == 1) {
    std::cout << "\tUsage: ALE_compareTreeDistributions treeDist1.trees "
                 "burnin1 treeDist2.trees burnin2\n"
              << std::endl;
  } else {
    ...
    cout << "# observe " << ale2->observations << "trees from: " << argv[4]
         << endl;
    ale2->save_state(ale_name2);
    cout << "# saved in " << ale_name2 << endl;

    // Now we want to compute the probabilities of all trees included in the
    // files, according to the two ales. First, we get all trees and put them in
    // a single vector
